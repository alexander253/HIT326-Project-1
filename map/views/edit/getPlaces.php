...
// Perform query
$sql = "SELECT * FROM map ORDER BY id ASC";
        ...
        echo "<table class='table table-hover table-sm'>";
            ...
            while($row = mysqli_fetch_array($result)){
                echo "<tr class='d-flex'>";
                    ...
                    $parameters = $row['id'].",\"".$row['title']."\",\"".$row['description']."\",\"".$row['lat']."\",\"".$row['lng']."\"";
                ...
                echo "<td colspan='4'>
                        <div class='row'>
                            <div class='col-10'>
                                <div class='col-12'><i class='far fa-clock mr-2' title='Open hours'></i><span></span></div>
